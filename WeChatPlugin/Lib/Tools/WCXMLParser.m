...
{
    WCXMLParser *reader = [[WCXMLParser alloc] initWithError:error];
...
+ (NSDictionary *)dictionaryForXMLString:(NSString *)string error:(NSError **)error
{
    ...
    return [WCXMLParser dictionaryForXMLData:data error:error];
}
...
{
    NSData *data = [string dataUsingEncoding:NSUTF8StringEncoding];
    return [WCXMLParser dictionaryForXMLData:data options:options error:error];
}
